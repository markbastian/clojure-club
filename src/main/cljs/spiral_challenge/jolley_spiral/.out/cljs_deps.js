...
goog.addDependency("../cljs/js.js", ['cljs.js'], ['cljs.compiler', 'cljs.tools.reader', 'cljs.core', 'goog.crypt.base64', 'cljs.tools.reader.reader_types', 'cljs.env', 'goog.string.StringBuffer', 'cljs.tagged_literals', 'cljs.analyzer', 'cljs.source_map', 'clojure.string', 'cljs.spec.alpha', 'clojure.walk']);
...
goog.addDependency("../lightmod/init.js", ['lightmod.init'], ['eval_soup.core', 'adzerk.boot_reload.connection', 'adzerk.boot_reload.reload', 'goog.dom', 'adzerk.boot_reload.display', 'goog.net.XhrIo', 'cljs.core', 'goog.object', 'adzerk.boot_reload.client', 'cljs.reader']);
...
goog.addDependency("../spiral/client.js", ['spiral.client'], ['reagent.core', 'cljs.core']);
