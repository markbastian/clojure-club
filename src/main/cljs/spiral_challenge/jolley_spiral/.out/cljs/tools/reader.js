...
var G__1441 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__1441;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__1442 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1442,ch);
...
if(("\\" === ch__$1)){
var ch_1443__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_1443__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_1443__$2);
} else {
}

var G__1444 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__1444;
continue;
}
}
...
var vec__1452 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1452,(0),null);
var start_column = cljs.core.nth.call(null,vec__1452,(1),null);
...
var G__1455 = cljs.core.conj_BANG_.call(null,a,form);
a = G__1455;
continue;
}
}
...
var _STAR_read_delim_STAR_1456 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_1456;
}});
/**
...
var vec__1469 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1469,(0),null);
var start_column = cljs.core.nth.call(null,vec__1469,(1),null);
...
var vec__1472 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1472,(0),null);
var end_column = cljs.core.nth.call(null,vec__1472,(1),null);
...
var sb = (function (){var G__1475 = (new goog.string.StringBuffer());
G__1475.append(initch);
...
var G__1477 = (function (){var G__1476 = sb;
G__1476.append(ch);

return G__1476;
})();
var G__1478 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__1477;
ch = G__1478;
continue;
}
...
switch (G__1481) {
case "\\":
var G__1485 = (function (){var G__1482 = sb;
G__1482.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__1482;
})();
var G__1486 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1485;
ch = G__1486;
continue;
...
break;
default:
var G__1487 = (function (){var G__1483 = sb;
G__1483.append(ch);

return G__1483;
})();
var G__1488 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1487;
ch = G__1488;
continue;
...
var vec__1489 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1489,(0),null);
var end_column = cljs.core.nth.call(null,vec__1489,(1),null);
...
var vec__1492 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1492,(0),null);
var column = cljs.core.nth.call(null,vec__1492,(1),null);
...
var vec__1497 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1497,(0),null);
var column = cljs.core.nth.call(null,vec__1497,(1),null);
...
var vec__1502 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1502,(0),null);
var column = cljs.core.nth.call(null,vec__1502,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__1507 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1507,(0),null);
var start_column = cljs.core.nth.call(null,vec__1507,(1),null);
...
var vec__1510 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1510,(0),null);
var end_column = cljs.core.nth.call(null,vec__1510,(1),null);
...
var G__1513 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__1513,true,null,opts,pending_forms);
...
var G__1514 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__1514)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__1514)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__1514)){
...
var _STAR_suppress_read_STAR_1515 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_1515;
}});
...
var G__1516 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__1516,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__1516,rdr,first_line);
...
var G__1520 = matched;
var G__1521 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__1520;
finished = G__1521;
continue;
} else {
...
var _STAR_suppress_read_STAR_1522 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_1522;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env1523 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__1524 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1524,"(");
...
var G__1525 = (i + (1));
var G__1526 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env1523;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__1527 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__1527);
...
var G__1528 = cljs.core.next.call(null,s__$1);
var G__1529 = ret;
s__$1 = G__1528;
r = G__1529;
continue;
...
var G__1530 = cljs.core.next.call(null,s);
var G__1531 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__1530;
key_vals = G__1531;
continue;
} else {
...
var gensym_env1535 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env1535;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__1536 = token;
var G__1536__$1 = (((G__1536 == null))?null:cljs.core.subs.call(null,G__1536,(1)));
var G__1536__$2 = (((G__1536__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1536__$1));
var G__1536__$3 = (((G__1536__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1536__$2));
var G__1536__$4 = (((G__1536__$3 == null))?null:cljs.core.symbol.call(null,G__1536__$3));
if((G__1536__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__1536__$4);
}
})():(function (){var G__1537 = token;
var G__1537__$1 = (((G__1537 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1537));
if((G__1537__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1537__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e1544){if((e1544 instanceof Error)){
var e = e1544;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__1548,reader){
var map__1549 = p__1548;
var map__1549__$1 = ((((!((map__1549 == null)))?(((((map__1549.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1549.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1549):map__1549);
var opts = map__1549__$1;
var eof = cljs.core.get.call(null,map__1549__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
