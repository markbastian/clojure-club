...
var digit_2716 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_2717__$1 = (vlq >>> (5));
while(true){
if((vlq_2717__$1 > (0))){
var digit_2718__$1 = (digit_2716 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_2718__$1));

var G__2719 = (vlq_2717__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__2720 = (vlq_2717__$1 >>> (5));
digit_2716 = G__2719;
vlq_2717__$1 = G__2720;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_2716));
}
break;
}
...
var G__2721 = i__$1;
var G__2722 = result__$1;
var G__2723 = shift__$1;
i = G__2721;
result = G__2722;
shift = G__2723;
continue;
