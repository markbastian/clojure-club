...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19034__auto__,writer__19035__auto__,opt__19036__auto__){
return cljs.core._write.call(null,writer__19035__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__20131 = o;
(G__20131[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_20135 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_20135))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_20135)].join(''):class$));
} else {
}
...
var G__20138 = jsprops;
(G__20138["defaultValue"] = value);

(G__20138["onChange"] = ((function (G__20138,v,value,on_change){
return (function (p1__20136_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__20136_SHARP_);
});})(G__20138,v,value,on_change))
);
...
var vec__20140 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__20140,(0),null);
var id = cljs.core.nth.call(null,vec__20140,(1),null);
var class$ = cljs.core.nth.call(null,vec__20140,(2),null);
...
var temp__4659__auto__ = (function (){var G__20144 = cljs.core.meta.call(null,v);
if((G__20144 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__20144);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__20146_20147 = v;
var G__20146_20148__$1 = (((G__20146_20147 == null))?null:reagent.impl.template.key_from_vec.call(null,G__20146_20147));
if((G__20146_20148__$1 == null)){
} else {
(jsprops["key"] = G__20146_20148__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__20151 = cljs.core.meta.call(null,argv);
if((G__20151 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__20151);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__20152 = (((jsprops == null))?{}:jsprops);
(G__20152["key"] = key);
...
var G__20153 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__20153;
continue;
}
} else {
...
var n__19343__auto___20154 = a.length;
var i_20155 = (0);
while(true){
if((i_20155 < n__19343__auto___20154)){
(a[i_20155] = reagent.impl.template.as_element.call(null,(a[i_20155])));
...
var a = cljs.core.into_array.call(null,s);
var n__19343__auto___20157 = a.length;
var i_20158 = (0);
while(true){
if((i_20158 < n__19343__auto___20157)){
var val_20159 = (a[i_20158]);
if((cljs.core.vector_QMARK_.call(null,val_20159)) && ((reagent.impl.template.key_from_vec.call(null,val_20159) == null))){
(o["no-key"] = true);
} else {
}

(a[i_20158] = reagent.impl.template.as_element.call(null,val_20159));

var G__20160 = (i_20158 + (1));
i_20158 = G__20160;
continue;
} else {
}
...
var G__20162 = (cljs.core.count.call(null,argv) - first_child);
switch (G__20162) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__20162){
...
//# sourceMappingURL=template.js.map?rel=1490072957475