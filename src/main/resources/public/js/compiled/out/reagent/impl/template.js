...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25830__auto__,writer__25831__auto__,opt__25832__auto__){
return cljs.core._write.call(null,writer__25831__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__26888 = o;
(G__26888[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__26889__delegate = function (args){
...
while (G__26890__i < G__26890__a.length) {G__26890__a[G__26890__i] = arguments[G__26890__i + 0]; ++G__26890__i;}
  args = new cljs.core.IndexedSeq(G__26890__a,0);
} 
...
var args = cljs.core.seq(arglist__26891);
...
if(cljs.core.truth_((function (){var and__25207__auto__ = !((jsprops == null));
if(and__25207__auto__){
var and__25207__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__26896 = jsprops;
(G__26896["defaultValue"] = value);

(G__26896["onChange"] = ((function (G__26896,v,value,on_change){
return (function (p1__26894_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26894_SHARP_);
});})(G__26896,v,value,on_change))
);
...
var vec__26903 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26903,(0),null);
var id = cljs.core.nth.call(null,vec__26903,(1),null);
var class$ = cljs.core.nth.call(null,vec__26903,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26908 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26908 == null)){
} else {
var key_26909 = temp__4661__auto___26908;
(jsprops["key"] = key_26909);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26911 = (new reagent.impl.template.NativeWrapper());
(G__26911["name"] = c);
...
var len__26332__auto___26917 = arguments.length;
var i__26333__auto___26918 = (0);
while(true){
if((i__26333__auto___26918 < len__26332__auto___26917)){
args__26339__auto__.push((arguments[i__26333__auto___26918]));

var G__26919 = (i__26333__auto___26918 + (1));
i__26333__auto___26918 = G__26919;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26340__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26915){
var G__26916 = cljs.core.first.call(null,seq26915);
var seq26915__$1 = cljs.core.next.call(null,seq26915);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26916,seq26915__$1);
});
...
break;
default:
var G__26923 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26923;
continue;
...
var n__26142__auto___26926 = a.length;
var i_26927 = (0);
while(true){
if((i_26927 < n__26142__auto___26926)){
(a[i_26927] = reagent.impl.template.as_element.call(null,(a[i_26927])));
...
var a = cljs.core.into_array.call(null,s);
var n__26142__auto___26929 = a.length;
var i_26930 = (0);
while(true){
if((i_26930 < n__26142__auto___26929)){
var val_26931 = (a[i_26930]);
if((cljs.core.vector_QMARK_.call(null,val_26931)) && ((reagent.impl.template.key_from_vec.call(null,val_26931) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26930] = reagent.impl.template.as_element.call(null,val_26931));

var G__26932 = (i_26930 + (1));
i_26930 = G__26932;
continue;
} else {
}
...
var ctx = ({});
var vec__26936 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26936,(0),null);
var derefed = cljs.core.nth.call(null,vec__26936,(1),null);
...
var G__26940 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26940) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26940){
...
//# sourceMappingURL=template.js.map?rel=1491273373322