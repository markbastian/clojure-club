...
clojure_club.x106_number_maze.wmatson.even_operations = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"double","double",884886883),cljs.core.partial.call(null,cljs.core._STAR_,(2)),new cljs.core.Keyword(null,"halve","halve",-1810937727),(function (p1__29764_SHARP_){
return (p1__29764_SHARP_ / (2));
...
clojure_club.x106_number_maze.wmatson.take_path = (function clojure_club$x106_number_maze$wmatson$take_path(node,p__29765){
var vec__29767 = p__29765;
var op_kw = cljs.core.nth.call(null,vec__29767,(0),null);
var op = cljs.core.nth.call(null,vec__29767,(1),null);
...
return cljs.core.not_any_QMARK_.call(null,is_solution_QMARK_,p1__29768_SHARP_);
...
var ops = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__29769_SHARP_){
return ((2) * p1__29769_SHARP_);
}),(function (p1__29770_SHARP_){
return ((2) + p1__29770_SHARP_);
}),(function (p1__29771_SHARP_){
return (p1__29771_SHARP_ / (2));
})], null);
var branch_single = ((function (ops){
return (function (num){
return cljs.core.map.call(null,((function (ops){
return (function (p1__29772_SHARP_){
return p1__29772_SHARP_.call(null,num);
});})(ops))
,ops);
});})(ops))
;
...
;
var branch_seq = cljs.core.iterate.call(null,branch,cljs.core.PersistentHashSet.fromArray([start], true));
...
return p1__29773_SHARP_.call(null,finish);
...
//# sourceMappingURL=wmatson.js.map?rel=1490073122030