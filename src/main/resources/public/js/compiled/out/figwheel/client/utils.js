...
return (new CustomEvent(event_name,(function (){var obj32657 = {"detail":data};
return obj32657;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25207__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25207__auto__)){
var and__25207__auto____$1 = (window["CustomEvent"]);
...
var args32662 = [];
var len__26332__auto___32668 = arguments.length;
var i__26333__auto___32669 = (0);
while(true){
if((i__26333__auto___32669 < len__26332__auto___32668)){
args32662.push((arguments[i__26333__auto___32669]));

var G__32670 = (i__26333__auto___32669 + (1));
i__26333__auto___32669 = G__32670;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args32662.length)].join('')));
...
var f = (function (){var pred__32665 = cljs.core._EQ_;
var expr__32666 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32665.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32666))){
return ((function (pred__32665,expr__32666){
return (function (p1__32658_SHARP_){
return console.warn(p1__32658_SHARP_);
});
;})(pred__32665,expr__32666))
} else {
if(cljs.core.truth_(pred__32665.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32666))){
return ((function (pred__32665,expr__32666){
return (function (p1__32659_SHARP_){
return console.debug(p1__32659_SHARP_);
});
;})(pred__32665,expr__32666))
} else {
if(cljs.core.truth_(pred__32665.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32666))){
return ((function (pred__32665,expr__32666){
return (function (p1__32660_SHARP_){
return console.error(p1__32660_SHARP_);
});
;})(pred__32665,expr__32666))
} else {
return ((function (pred__32665,expr__32666){
return (function (p1__32661_SHARP_){
return console.log(p1__32661_SHARP_);
});
;})(pred__32665,expr__32666))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32672){
...
var opts = map__32675__$1;
var eval_fn = cljs.core.get.call(null,map__32675__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32677_SHARP_);
});})(new_def))
);
...
return (function (p__32678){
var vec__32679 = p__32678;
var ky = cljs.core.nth.call(null,vec__32679,(0),null);
...
var args32682 = [];
var len__26332__auto___32685 = arguments.length;
var i__26333__auto___32686 = (0);
while(true){
if((i__26333__auto___32686 < len__26332__auto___32685)){
args32682.push((arguments[i__26333__auto___32686]));

var G__32687 = (i__26333__auto___32686 + (1));
i__26333__auto___32686 = G__32687;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args32682.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25207__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1491273376800